...
class MyCatalogContainer extends StatefulWidget {
  @override
  State<MyCatalogContainer> createState() => _MyCatalogContainerState();
}

class _MyCatalogContainerState extends State<MyCatalogContainer> {
  int jami = 0;
  int korzina = 0;
  int allValuePlus = 0;

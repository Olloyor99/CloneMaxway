...
import '../pdoduct_name/variables.dart';
...
class _CatalogState extends State<Catalog> {
  ...
  Widget build(BuildContext context) {
    return SliverGrid(
      ...
      delegate: SliverChildBuilderDelegate(childCount: lavashnomi.length,
          (BuildContext, int index) {
        return AnimatedContainer(
          duration: Duration(milliseconds: 400),
          curve: Curves.bounceInOut,
          margin: withOpasity[index] ? EdgeInsets.all(15) : EdgeInsets.all(12),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage("${photos[index].toString()}"),
                        fit: BoxFit.cover),
                    borderRadius: BorderRadius.circular(12)),
                child: shtuk[index] >= 1
                    ? Container(
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        shtuk[index] > 0 ? allValuePlus += shtuk[index] : 0;
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  korzina = jami;
                                  withOpasity[index] = !withOpasity[index];
                                  shtuk[index] == 0 ? allValuePlus -= 1 : 0;
                                  aloneValue[index] -= lavashnarxi[index];
